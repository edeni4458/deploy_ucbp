        ...
        <div className="mid-about-div">
            <div className="container-subText">
                <div className="subText">
                    ...
                    <p>Join us and become part of this growing force as we explore and discuss the epic game that has brought us great story telling and amazing memories.</p>
            ...
            <div className="support-text-container">
                ...
                <a className='btn btn-danger ' href="https://www.patreon.com/UCBPodcast/membership" target='_blank' rel="noreferrer">Deploy Here</a>
            </div>
        </div>
    )
}
